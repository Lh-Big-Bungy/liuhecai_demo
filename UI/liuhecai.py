...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.time_date_label = QtWidgets.QLabel(self.centralwidget)
        ...
        self.number_edit = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.table_commit = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.tail_large = QtWidgets.QPushButton(self.centralwidget)
        self.tail_large.setObjectName("tail_large")
        self.gridLayout.addWidget(self.tail_large, 3, 5, 1, 1)
        self.red_single = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.tail_minor = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.blue_single = QtWidgets.QPushButton(self.centralwidget)
        self.blue_single.setObjectName("blue_single")
        self.gridLayout.addWidget(self.blue_single, 2, 1, 1, 1)
        self.composite_even = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.blue_even = QtWidgets.QPushButton(self.centralwidget)
        self.blue_even.setObjectName("blue_even")
        self.gridLayout.addWidget(self.blue_even, 2, 2, 1, 1)
        self.minor = QtWidgets.QPushButton(self.centralwidget)
        self.minor.setObjectName("minor")
        self.gridLayout.addWidget(self.minor, 2, 4, 1, 1)
        self.soil = QtWidgets.QPushButton(self.centralwidget)
        self.soil.setObjectName("soil")
        self.gridLayout.addWidget(self.soil, 3, 4, 1, 1)
        self.pig = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.even = QtWidgets.QPushButton(self.centralwidget)
        self.even.setObjectName("even")
        self.gridLayout.addWidget(self.even, 1, 3, 1, 1)
        self.green_even = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.green_single = QtWidgets.QPushButton(self.centralwidget)
        self.green_single.setObjectName("green_single")
        self.gridLayout.addWidget(self.green_single, 1, 1, 1, 1)
        self.wood = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.chicken = QtWidgets.QPushButton(self.centralwidget)
        self.chicken.setObjectName("chicken")
        self.gridLayout.addWidget(self.chicken, 2, 6, 1, 1)
        self.red_even = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.gold = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.dragon = QtWidgets.QPushButton(self.centralwidget)
        self.dragon.setObjectName("dragon")
        self.gridLayout.addWidget(self.dragon, 1, 5, 1, 1)
        self.composite_single = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.goat = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.seq_input = QtWidgets.QLineEdit(self.centralwidget)
        self.seq_input.setObjectName("seq_input")
        self.horizontalLayout_4.addWidget(self.seq_input)
        self.commit_two = QtWidgets.QPushButton(self.centralwidget)
        ...
        self.clear_textbrowser = QtWidgets.QPushButton(self.centralwidget)
        self.clear_textbrowser.setObjectName("clear_textbrowser")
        self.horizontalLayout_7.addWidget(self.clear_textbrowser)
        self.analysis_report = QtWidgets.QPushButton(self.centralwidget)
